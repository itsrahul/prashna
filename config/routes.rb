Rails.application.routes.draw do
  resources :purchase_packs, only: :index do
    get 'checkout/', to: 'purchase_packs#new', on: :member
    post 'checkout/', to: 'purchase_packs#create', on: :member
  end
  # get 'purchase_packs/index'
  # get 'checkout/create/:id', to: 'purchase_packs#new', as: 'checkout_new'
  # post 'checkout/create/:id', to: 'purchase_packs#create', as: 'checkout_create'
  # get 'checkout/cancel', to: 'purchase_packs#cancel'
  # get 'checkout/success', to: 'purchase_packs#success'
